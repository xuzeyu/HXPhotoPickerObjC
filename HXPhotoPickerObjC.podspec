Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xuzeyu/HXPhotoPickerObjC"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author       = { "SilenceLove" => "topy-123@qq.com" }

  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/xuzeyu/HXPhotoPickerObjC.git", :tag => "#{s.version}" }
  ...
  s.subspec 'Default' do |de|
    ...
    de.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
  end
  
  s.subspec 'SDWebImage' do |sd|
    sd.source_files = "HXPhotoPicker/**/*.{h,m}"
    sd.dependency 'SDWebImage'
    sd.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
  end
  
  s.subspec 'SDWebImage_AF' do |sd_af|
    sd_af.source_files = "HXPhotoPicker/**/*.{h,m}"
    sd_af.dependency 'SDWebImage'
    sd_af.dependency 'AFNetworking'
    sd_af.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
  end
  
  s.subspec 'YYWebImage' do |yy|
    yy.source_files = "HXPhotoPicker/**/*.{h,m}"
    yy.dependency 'YYWebImage', '~> 1.0.5'
    yy.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
  end
  ...
  s.subspec 'YYWebImage_AF' do |yy_af|
    ...
    yy_af.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
  end
  
  s.subspec 'CustomItem' do |customItem|
    customItem.source_files = "HXPhotoPicker/**/*.{h,m}"
    customItem.dependency 'SDWebImage'
    customItem.dependency 'AFNetworking'
    customItem.resources = ["HXPhotoPicker/Resources/*.{bundle}", "HXPhotoPicker/Resources/PrivacyInfo.xcprivacy"]
